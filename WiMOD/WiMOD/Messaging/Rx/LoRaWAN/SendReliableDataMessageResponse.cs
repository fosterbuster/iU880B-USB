...
namespace WiMOD.Messaging.Rx.LoRaWAN
{
    ...
    /// </summary>
    public class SendReliableDataMessageResponse : LoRaWanRxHciMessage
    {
        /// <summary>
        ...
        {
            return "Send Reliable Data Message Response Response. Status: " + Status.ToString() + (BlockedByDutyCycle ? $"Time remaining till channel available: {TimeUntilChannelAvailableMillis} ms." : ".");
        }
    }
}